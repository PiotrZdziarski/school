                    ...
                    <div class="card shadow-v1">
                        <div class="card-body padding20lowwidth">
                            <section id="content">
                                ...
                                <img class="float-left paddingTop-20 paddingRight-20 paddingTop-20 portraitimage" src="{{url('assets/img/school/chelmonski.jpg')}}">
