    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mx-auto">
                ...
                <div class="mx-auto" style="display: flex; justify-content: center; align-items: center; margin-bottom: 20px; ">
                                ...
                                <div class="collapse collapseedit boxshadow" id="collapse{{$aktualnosc->id}}">
                                    <div class="card card-body">
                                        <form action="{{url('/editaktualnosc')}}" method="POST" class="px-lg-4">
                                            ...
                                            <div class="input-group input-group--focus mb-3">
                                                <textarea rows="3" name="description" maxlength="200" required title="opis"
