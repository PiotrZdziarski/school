                ...
                <ul class="nav navbar-nav ec-nav__navbar ml-auto">
                    <li class="nav-item nav-item__has-dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-unstyled">
                                ...
                                <li><a class="nav-link__list" href="{{url('/samorzad_szkolny')}}">Samorząd szkolny</a></li>
                                ...
                                <li class="nav-item__has-dropdown">
                                    <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> Koło wychowanków </a>
                                    <div class="dropdown-menu">
                                        <ul class="list-unstyled">
                                            <li><a class="nav-link__list" href="page-login.html"> Sławni absolwenci</a></li>
                                            <li><a class="nav-link__list" href="page-signup.html"> Historia od 1939r.</a></li>
                                            <li><a class="nav-link__list" href="page-signup.html"> Biografie prezesów</a></li>
                                            <li><a class="nav-link__list" href="page-signup.html"> Zjazd kol. od 1939 r.</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="nav-item__has-dropdown">
                                    <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> Klub historyczny AK </a>
                                    <div class="dropdown-menu">
                                        <ul class="list-unstyled">
                    ...
                    <li class="nav-item nav-item__has-dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="nav-item__has-dropdown">
                                <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> Biblioteka </a>
                                <div class="dropdown-menu">
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a class="nav-link__list" href="page-login.html">Lektury Obowiązkowe</a></li>
                                        <li><a class="nav-link__list" href="page-login.html">Czasompisma w bibliotece</a></li>
                                        <li><a class="nav-link__list" href="page-login.html">Fimoteka</a></li>
                                        <li><a class="nav-link__list" href="page-login.html">Nowości w bibliotece szkolnej</a></li>
                                        <li><a class="nav-link__list" href="page-login.html">Biblioteki On-Line</a></li>
                                        <li><a class="nav-link__list" href="page-login.html">Biblioteki w Łowiczu</a></li>
                                        <li><a class="nav-link__list" href="page-login.html">Jak tworzyć bibliografię?</a></li>
                                        <li><a class="nav-link__list" href="page-login.html">Bookcrossing</a></li>
                                        <li><a class="nav-link__list" href="page-login.html">Regulamin centrum informacji medialnej</a></li>
                                        <li><a class="nav-link__list" href="page-login.html">Ciekawe strony internetowe</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li><a href="page-sp-all-courcess.html" class="nav-link__list">Święta i dni wolne</a></li>
                            <li><a href="page-sp-all-courcess-list.html" class="nav-link__list">Zebrania z rodzicami</a></li>
                            <li><a href="page-sp-all-courcess-with-sidebar.html" class="nav-link__list">Wydawanie duplikatów</a></li>
                            ...
                            <li><a href="page-sp-course-details.html" class="nav-link__list">Dziennik elektroniczny</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item nav-item__has-dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-unstyled">
                                ...
                                <li class="nav-item__has-dropdown">
                                    <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> Stypendyści </a>
                                    <div class="dropdown-menu">
                                        <ul class="list-unstyled">
                                            <li><a class="nav-link__list" href="page-events.html"> Prezesa Rady Ministrów </a></li>
                                            <li><a class="nav-link__list" href="page-event-details.html"> Zarządy Starostwa Powiatowego w Łowiczu</a></li>
                                        </ul>
                                    </div>
                                </li>

                                <li class="nav-item__has-dropdown">
                                    <a class="nav-link__list dropdown-toggle" href="#" data-toggle="dropdown"> Osiągnięcia w olimpiadach i konkursach </a>
                                    <div class="dropdown-menu">
                                        <ul class="list-unstyled">
                                            ...
                                            <li><a class="nav-link__list" href="page-events.html"> Edukacja dla bezpieczeństwa</a></li>
                                            <li><a class="nav-link__list" href="page-events.html"> Filozofia</a></li>
                                            <li><a class="nav-link__list" href="page-events.html"> Fizyka i astronomia</a></li>
                                            ...
                                            <li><a class="nav-link__list" href="page-events.html"> Język angielski</a></li>
                                            <li><a class="nav-link__list" href="page-events.html"> Język francuski</a></li>
                                            <li><a class="nav-link__list" href="page-events.html"> Język niemiecki</a></li>
                                            <li><a class="nav-link__list" href="page-events.html"> Język polski</a></li>
                                            <li><a class="nav-link__list" href="page-events.html"> Język rosyjski</a></li>
                                            <li><a class="nav-link__list" href="page-events.html"> Matematyka</a></li>
                                            <li><a class="nav-link__list" href="page-events.html"> Przedsiębiorczość</a></li>
                                            ...
                                            <li><a class="nav-link__list" href="page-events.html"> Wiedza o społeczeństwie</a></li>
