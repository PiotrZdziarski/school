                            ...
                            <section id="content">
                                <div class="col-lg-12 my-1">
                                    ...
                                    <ul class="fa-ul">
                                        ...
                                        <li><a href="{{url('/gloria_diligentiae_et_labori')}}"><span class="fa-li"><i class="ti-angle-right  colordodgerblue"></i></span>Nagroda im. dr. Jana Wegnera (dla najlepszego historyka)</a></li>
                                        <li><a href="{{url('/gloria_diligentiae_et_labori')}}"><span class="fa-li"><i class="ti-angle-right  colordodgerblue"></i></span>Nagroda im. prof. Jana Zbudniewka (dla najlepszego chemika, fizyka, oraz matematyka)</a></li>
                                        <li><a href="{{url('/gloria_diligentiae_et_labori')}}"><span class="fa-li"><i class="ti-angle-right  colordodgerblue"></i></span>Nagroda im. prof. Eugeniusza Wachowskiego (dla najlepszego sportowca)</a></li>
                                        <li><a href="{{url('/gloria_diligentiae_et_labori')}}"><span class="fa-li"><i class="ti-angle-right  colordodgerblue"></i></span>Nagroda im. Józefa Chełmońskiego (dla najlepszego z przedmiotów artystycznych)</a></li>
                                    </ul>
                                </div>
